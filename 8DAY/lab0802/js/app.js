...
/**
 * instanceof 연산자
 * instanceof 연산자는 지정한 객체의 프로토타입 체인에 지정한 생성자의 프로토타입 객체가 포함되어 있는지 확인
...
console.log(obj instanceof Object); // true 상속되어 있어서
console.log(obj instanceof Date); // false 상속 안되어 있음
